...
class Detector:
    ...
    def __init__(self):
        ...
        self.state_pub = rospy.Publisher('data_state',MsgState)##
    ...
    def image_cb(self, data):
        ...
        objects,x_mid,y_mid,box_count,box_size=vis_util.visualize_boxes_and_labels_on_image_array(
            image,
            np.squeeze(boxes),
        ...
        pub = rospy.Publisher('data_state',MsgState)
        
        ##커스텀 메시지 콜
        msg=MsgState()
        msg.x_mid = x_mid
        msg.y_mid = y_mid
        msg.box_size = box_size
